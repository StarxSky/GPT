import torch
import jieba # 这里的话如果您使用的是我仓库的预先训练好的模型的话，请您将分词功能打开！！
import os
import numpy as np
...
pp = 'C:\\Users\\xbj0916\\Desktop\\GPT\\CNGPT\\datas\\'#str(input("输入您存放训练数据的文件夹目录："))
################
# 得到文本文件
