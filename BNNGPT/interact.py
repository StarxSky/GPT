import os
import torch
import jieba # 这里也记得打开，（前提是您的模型用到分词功能）
import numpy as np
...
pre_model_path = 'C:\\Users\\xbj0916\\Desktop\\GPT\\CNGPT\\Pre_models\\{}'.format(model_path)

# CUDA确认
GPU = bool(input("请确认您是否有CUDA(Yes:True,None:False)："))

pp = 'C:\\Users\\xbj0916\\Desktop\\GPT\\CNGPT\\datas\\'#str(input("请输入数据文件夹的名称："))
