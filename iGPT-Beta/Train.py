...
from Core.Datasets import Images_load_local
...
# 加载数据
#root = './'
#train_data  = torchvision.datasets.CIFAR10(root, train=False, transform=None, target_transform=None, download=True)
...
px = torch.cat([pluck_rgb(x) for x in train_data], dim=0).float()
print(px.size())
